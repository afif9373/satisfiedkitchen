  ...
  return (
    <SafeAreaView className='flex-1' edges={['top']}>
      ...
      <ScrollView className='flex-1 px-4'
        ...
        {/* Banner Slider */}
        <View className='mb-6'>
          <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} className='w-full h-48 rounded-2xl'
        ...
        <View className='bg-gray-100 p-6 rounded-2x1 mb-20 items-center'>
          <Text className='text-2xl font-bold text-primary mb-2 text-center'>Coded By Afif Hafizin</Text>
          <Text className='text-secondary text-center mb-4'>Subscribe to my channel for more content.</Text>
